...
<Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>용인푸르지오 원클러스터2단지 - 분양일정</title>
        <meta
          name="description"
          content="용인푸르지오원클러스터의 최신 분양일정을 확인하고, 분양 일정 및 세부 사항을 이 페이지에서 자세히 확인하세요. 놓치지 마세요!
"
        />
          ...
          {`
                                        {
                                            ...
                                            "@type": "WebPage",
                                            "name": "용인푸르지오 원클러스터2단지 - 분양일정",
                                            "description": "용인푸르지오원클러스터의 최신 분양일정을 확인하고, 분양 일정 및 세부 사항을 이 페이지에서 자세히 확인하세요. 놓치지 마세요!
",
            ...
            <h1 className={styles.screenReaderOnly}>용인푸르지오원클러스터 - 분양일정</h1>
            <p className={styles.screenReaderOnly}>
			용인푸르지오원클러스터의 분양 일정은 중요한 날짜들을 안내하는 핵심 정보입니다.
            </p>
            ...
            <img className={`${styles.image4} ${isImageVisible ? styles.visible : ''}`} src={page1} alt="용인 푸르지오원 클러스터 분양일정안내-image1" />
