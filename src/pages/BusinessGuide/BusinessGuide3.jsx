...
const BusinessGuide2 = () => {
	...
	return (
		<div className={styles.container}>  
            ...
            <h1 className={styles.screenReaderOnly}>청주센텀푸르지오자이 - 계약서류안내</h1>
			...
			<img className={`${styles.image4} ${isImageVisible ? styles.visible : ''}`} src={page1} alt="청주센텀푸르지오자이 계약서류안내-image1" />
